...
const ORIENTASI_INTERACTIVE_MATERIALS: InteractiveMaterialCatalog = {
  ...
  'orientasi-pplg-05-job-fair-kelas': {
    ...
    activities: [
      { id: 'or05-booth', kind: 'checklist', title: 'Cek strategi booth', instruction: 'Pastikan booth profesimu siap menjelaskan peran kepada pengunjung.', items: [item('Profil profesi', 'Siapkan tugas utama profesi yang dipromosikan.', 'Pengunjung perlu memahami peran inti.'), item('Tech stack', 'Tampilkan bahasa atau tools yang relevan.', 'Tools membuat profesi terasa konkret.'), item('Contoh karya', 'Sertakan hasil kerja atau kasus penggunaan.', 'Contoh membantu menjelaskan dampak profesi.'), item('Tantangan kerja', 'Jelaskan hambatan yang biasa dihadapi.', 'Informasi jujur mendukung pilihan minat.'), item('Ajakan bertanya', 'Sambut pengunjung dengan pertanyaan terbuka.', 'Dialog menghasilkan wawasan lintas profesi.')], feedback: 'Booth yang baik informatif, jujur, dan mengundang percakapan.' },
      { id: 'or05-interview', kind: 'scenario', title: 'Pilih pertanyaan wawancara', instruction: 'Bedakan pertanyaan yang membantu memahami pekerjaan sehari-hari.', items: [item('Tugas harian', 'Tanyakan pekerjaan yang paling sering dilakukan.', 'Pertanyaan ini mengungkap realitas profesi.'), item('Tools utama', 'Tanyakan perangkat yang dipakai untuk bekerja.', 'Jawaban memberi arah skill yang perlu dilatih.'), item('Tantangan', 'Tanyakan masalah yang sering muncul.', 'Tantangan menunjukkan kesiapan yang dibutuhkan.'), item('Kolaborasi', 'Tanyakan profesi lain yang sering diajak bekerja.', 'Karier PPLG tumbuh melalui kerja tim.'), item('Jalur belajar', 'Tanyakan langkah awal untuk pemula.', 'Gunakan jawaban sebagai rencana belajar.')], feedback: 'Pertanyaan spesifik menghasilkan wawasan yang dapat ditindaklanjuti.' }
    ]
  },
