...
- Aktivitas `sequence` kini benar-benar dapat diurutkan ulang; semua aktivitas menampilkan detail dan umpan balik yang terlihat. Perilaku DOM lokal dipisahkan ke `src/utils/interactiveModuleMaterialBehavior.ts` agar renderer dapat diuji tanpa mengubah batas formatifnya.
